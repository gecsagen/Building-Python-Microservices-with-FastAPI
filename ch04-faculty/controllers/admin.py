...
from models.request.faculty import SignupReq, FacultyReq, FacultyDetails
from models.data.faculty import Signup, Login, Faculty
from services.signup import FacultySignupService
from services.login import FacultyLoginService
...
def create_profile(profile: FacultyReq):
    ...
    if result:
        ...
        return JSONResponse(
            content={"message": "student profile not created"}, status_code=500
        )
